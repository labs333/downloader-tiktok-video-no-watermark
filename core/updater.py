...
class UpdateChecker(QObject):
    ...
    def __init__(self):
        ...
        self.github_api_url = "https://api.github.com/repos/digitaldownloader/TikTokVideoURLDownloader/releases/latest"
        self.headers = {
            "User-Agent": f"TikTokLabsVideoURLDownloader/{VERSION} ({platform.system()} {platform.release()})",
